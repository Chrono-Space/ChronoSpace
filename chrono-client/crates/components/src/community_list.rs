...
pub fn CommunityList(write_select_group: WriteSignal<GroupInfo>) -> impl IntoView {
    let list = GroupList{list: vec![GroupInfo{ avatar: "avatar/6378806623340270811.webp".to_string(), nickname: "123".to_string() },
                                    GroupInfo{ avatar: "avatar/6378806623340270811.webp".to_string(), nickname: "123".to_string() }]};
